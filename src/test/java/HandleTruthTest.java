...
public class HandleTruthTest {
    ...
    public void realTest() {
        ...
        Set<String> set12 = new HashSet<>(Arrays.asList("here", "is", "a", "string"));
        expected5.put(1, set12);


        TreeMap<Integer, Set<String>>[] expectedResults = new TreeMap[5];
        expectedResults[0] = expected1;
        expectedResults[1] = expected2;
        expectedResults[2] = expected3;
        expectedResults[3] = expected4;
        expectedResults[4] = expected5;
